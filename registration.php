	...
	<div class="row headerrow">
        ...
        <div class="col-md-2" style="padding: 5px 5px;">
          ...
          <img style="float: right; width: 220px;" src="assets/img/jneclogo.png" alt=""> 
            ...
            <form class="container" method="post" action="register_a.php">
                <h1>
                    ENROLLEMENT FORM (NSS)
                </h1>
                <br>
                <div class="row1">
                    <div class="col">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="middlename">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputPassword" class="col-sm-3 col-form-label">LastName:</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="lastname">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputPassword" class="col-sm-3 col-form-label">Email:</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="email">
                            </div>
                        </div>

                        <div class="mb-3 row">
                            <label for="inputdate" class="col-sm-3 col-form-label">DateofBirth:</label>
                            <div class="col-sm-5">
                                <input type="date" class="form-control" id="inputdate" name="dateofbirth">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputplace" class="col-sm-3 col-form-label">PlaceofBirth:</label>
                            <div class="col-sm-5">
                                <input type="Birthplace" class="form-control" id="inputname" name="place">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputplace" class="col-sm-3 col-form-label">Gender:</label>
                            <div class="col-sm-5">
                        ...
                        <div class="mb-3 row">
                            <label for="inputname" class="col-sm-3 col-form-label">MotherName:</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="mothername">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputname" class="col-sm-3 col-form-label">Caste:</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="caste">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputPuncode" class="col-sm-3 col-form-label">AreaPinCode:</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="pincode">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputHeight" class="col-sm-3 col-form-label">Height(in cm):</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="height">
                            </div>
                        </div>
                        <div class="mb-3 row">

                            <label for="inputWeight" class="col-sm-3 col-form-label">Weight(in KG):</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="weight">
                            </div>
                        </div>

                        <div class="mb-3 row">

                            <label for="input" class="col-sm-3 col-form-label">ParticipatedIn:</label>
                            <div class="row1">
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3 row">
                            <label for="input" class="col-sm-3 col-form-label">BloodGroup:</label>
                            <div class="col-sm-5">
                        ...
                        <div class="mb-3 row">
                            <label for="input" class="col-sm-3 col-form-label">Spectacles:</label>
                            <div class="col-sm-5">
                        ...
                        <div class="mb-3 row">
                            <label for="input" class="col-sm-3 col-form-label">Whether belongs to minority?:</label>
                            <div class="col-sm-5">
                        ...
                        <div class="mb-3 row">
                            <label for="input" class="col-sm-3 col-form-label">IsVaccinated (Covid-19)?</label>
                            <div class="col-sm-5">
                        ...
                        <div class="mb-3 row">
                            <label for="inputWeight" class="col-sm-3 col-form-label">AadharCard no:</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="aadharcardno">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputWeight" class="col-sm-3 col-form-label">ElectionCard no:</label>
                            <div class="col-sm-5">
                                <input type="name" class="form-control" id="inputname" name="electioncardno">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputWeight" class="col-sm-3 col-form-label">LanguagesKnown:</label>
                            <div class="col-sm-5">
                        ...
                        <div class="mb-3 row">
                            ...
                            <label for="input" class="col-sm-2 col-form-label">ParticipatedActivity:</label>
                            <div class="row1">
                                <div class="col">
                                    <div class="form-check">
                        ...
                        <div class="mb-3 row">
                            ...
                            <label for="input" class="col-sm-2 col-form-label">SkillsKnown:</label>
                            <div class="row1">
                                <div class="col">
                                    <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn " style="background-color: #703c19 ; color:#fff;"  name="submit">Submit</button>
                                            </div> <!-- form-group// -->
                        </div>
                    </div>
                </div>
